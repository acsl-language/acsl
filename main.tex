%% This is the main file for the ACSL and ACSL++ language definition documents
%% There are four variants (C/C==) X (language/implementation)
%% They are all created from this document by rewriting this document to change
%% the values of two variables: isCPP and 
...
\subsection{Version 1.14} % Potassium
\begin{itemize}
