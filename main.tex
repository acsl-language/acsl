...
{\LARGE Preliminary design (version 1.2, \today)}

\vspace{20mm}

{P.~Baudin$^1$, J.-C.~Filli\^atre$^{4,3}$, C.~March\'e$^{3,4}$, B.~Monate$^1$, Y.~Moy$^{2,4,3}$, V.~Prevosto$^1$}

\medskip

\begin{tabular}{l}
$^1$ CEA LIST, LSL, Saclay, F-91191 \\
...
\begin{flushleft}
  ...
  (ANR-05-RNTL-00302) and by the ANR CIFRE contract 2005/973.
\end{flushleft}
...
This is the version 1.2 of ACSL design. Several features may still
