...
\item Addition of logical labels related to loops (section~\ref{sec:default-logic-labels}).
\item Addition of labels to built-in related to memory blocks.
\item Introduction of \lstinline|\valid_read| built-in and clarification of
the notion of validity (section~\ref{subsec:memory}).
\item Introduction of built-in \lstinline|\allocable|, \lstinline|\allocation|, 
  \lstinline|\freeable| and \lstinline|\fresh| (section~\ref{sec:allocation-clause}).
