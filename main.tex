...
\vfill
\begin{flushleft}
  \textcopyright 2009-2012 CEA LIST and INRIA
...
\item Introduction of \lstinline|\freeable|, \lstinline|\allocable|, 
  and \lstinline|\allocation| (section~\ref{sec:allocation-clause}).
\item Introduction of \lstinline|allocates| and \lstinline|frees| clauses
...
\item Improvements to the \lstinline|volatile| clause 
...
\begin{itemize}
\item Clarify the status of \lstinline|loop invariant| in presence of
  \lstinline|break| or side-effects in the loop test.
