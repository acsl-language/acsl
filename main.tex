...
\baseaddr{} base address of an allocated pointer

\blocklength{} length of the allocated block of a pointer

\comparable{} (checks whether two pointers are comparable as defined in the ANSI standard: TODO)

\remark{Claude}{veut-on aussi offset ? decalage entre un pointer et son adresse de base}
