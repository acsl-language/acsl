...
In such clause, \lstinline|\old(e)|\indexttbs{old}
...
and \assigns{} clauses. Of course, \result cannot be used in \exits{} clauses.
\end{notreviewedenv}
...
\begin{todo}
  Discuter de ext versus return pour la fonction main. Discuter
    ...
    \lstinline|\exit_status| vs \lstinline|\result| pour les clauses exit?
\end{todo}
