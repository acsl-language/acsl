...
If such a condition is sought, it is possible to add the following clause
to a contract:
...
More generally, we introduce syntactic constructs to denote \emph{sets of
  terms} which are also useful for \separated predicate (see Section~\ref{sec:separated})
