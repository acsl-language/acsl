...
\begin{itemize}
	...
	\item let statements with multiple parallel local bindings; let statement grammar does not look correct
...
\begin{itemize}
	...
	\item should min and max are any number of arguments
	...
	\item Jens: THere should be some text on how tyhe kinds of C++ reference types are treated in ACSL++ (compared to the treatment of pointers in ACSL).
	\item ownership?
