...
\lstinline|Old|,
\lstinline|Post|, \lstinline|LoopEntry| and \lstinline|LoopCurrent|.
...
\item The label 
\begin{notimplementedenv}\lstinline|LoopEntry|\end{notimplementedenv}
...
\item The label
\begin{notimplementedenv}\lstinline|LoopCurrent|\end{notimplementedenv} 
is visible in loop annotations and
...
section~\ref{sec:loop-invariants} for more details on what constitute a loop
...
(label \begin{notimplementedenv}\lstinline|LoopEntry|\end{notimplementedenv}), 
and \lstinline|Q$_i$| are evaluated in the current loop state 
(label \begin{notimplementedenv}\lstinline|LoopCurrent|\end{notimplementedenv}).
