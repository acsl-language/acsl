...
\[
\lstinline|length|(t) = (\lstinline|block_length|(p) - \lstinline|offset|(p))/\lstinline|sizeof|(\tau)
\]
...
$pt_i$ is a set of pointer terms as defined in Section~\ref{sec:locations}.
