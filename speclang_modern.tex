...
In addition, some operations involving pointers may lead to run-time errors.
...
adding or subtractiong an offset to a pointer, or comparing two pointers
...
and \lstinline|p2| points to the same function or to an element (or one past
