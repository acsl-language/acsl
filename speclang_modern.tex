...
post-state when the annotated statement terminates 
by a \lstinline|goto| jumping out of it.
There is the same kind of thing 
when the annotated statement terminates abruptly
...
\subsection{Allocation and deallocation}\label{sec:allocation-clause}
\indextt{allocates}\indextt{frees}
\index{allocation}\index{deallocation}
