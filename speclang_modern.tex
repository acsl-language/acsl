...
Like inductive definitions, there are no syntactic conditions that
...
types as arguments. Such a hybrid predicate (or function)
...
a hybrid function (or predicate) usually depends on one or
