...
\item If no loop assigns clause is given, assignments remain unspecified.
...
declared identifier a set of labels, between curly braces.
...
\item It is however possible to write multi-line annotations inside ghost
  ...
  (as previously, \lstinline|/*@ ... */| leads to incorrect C code).
