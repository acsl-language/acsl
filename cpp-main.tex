...
\newboolean{isCPP}
\setboolean{isCPP}{true}
\input{common}
\renewcommand{\version}{Potassium} %% Version of Frama-C
\renewcommand{\acslversion}{TODO} %% Version of ACSL document
\renewcommand{\ppversion}{0.1-REVIEW} %% Version of ACSL++ document
\renewcommand{\fclangversion}{0.1-REVIEW} %% Version of Frama-Clang software
...
\ifthenelse{\boolean{PrintImplementationRq}}%
  {\coverpage{\vbox{\mbox{\NAME Version \ppversion}\newline
\mbox{Implementation in \fclang \fclangversion{}}}}}%
...
\ifImpl{(Implementation Guide)}}%
{{Version \ppversion \vspace{1em}} \ifthenelse{\boolean{PrintImplementationRq}}%
{\newline {as implemented in \fclang version \fclangversion} \newline {for \framac version TBD}}
{}}
