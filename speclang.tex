...
contracts. Grammar for non-terminal \textsl{locations} is given later,
informally, they denote C l-values\index{lvalue}. 
...
$\at(e,id)$ refer to the value of the expression $e$ in the
state at label $id$.

, which has to appear before. Adding labels in
