...
\begin{itemize}
\item Global strong invariants: at any state of execution (i.e. at any
  \emph{sequence point} in the norm TODO: give a reference)(after
  initialisation of global data), the invariant holds.

\item Global weak invariants: at function entrance and function exit
  only

\item weak Type invariant: at any function entrance and exit, any
  global variable of this static type, and any formal parameter, and
  also the result value, satisfies the invariant. 

\item strong Type invariants: at any state of execution, any global
  variable, formal parameter or local variable, of this static type,
  and also the result value, satisfies the invariant.
...
\begin{example}
  ...
  //@ strong type invariant I(temperature t) { t >= -273.15 }
