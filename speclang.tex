...
\emph{terms}, fllowing the usual distinction between propositions and
...
Additional constructs:
  ...
  \item a rel-op b rel-op c shortcut for a rel-op b \&\& b rel-op c
  \end{itemize}

\subsection{Semantics and typing}

always defined (2-valued logic). 
