...
\begin{example}
  ...
  The two ensures clauses are equivalent. The
  simpler clause \verb|t[i] == \old(t[i]) + 1| would be wrong because
  in \verb|\old(t[i])|, \verb|i| denotes the value of $i$ n the
  pre-state.

  Also, the assigns clause \verb|i,t[i]| would be wrong too because
