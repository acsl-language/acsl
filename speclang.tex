...
\remark{Claude}{Revoir la spec, quantifier sur des integer, mettre des ints a la place des shorts}
...
\remark{SD5}{
  ...
  proposition de claude : un equivalent de 'assumes' portant sur le post-state. 
  behavior success:
