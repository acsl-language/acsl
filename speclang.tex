...
the pre-state. See Section~\ref{sec:at} for more details on scoping rules for labels.
...
\item The label \verb|Here| is visible in all statement annotations
  and all contracts, and refers the state where the annotation
  appears.
...
\begin{example}
  TODO: example with \at(e,Pre) in a loop invariant.
\end{example}
