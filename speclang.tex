...
The grammar for these declarations is given Figure~\ref{fig:gram:logic}.
...
the syntax given on Figure~\ref{fig:gram:logicreads}, which extends the
...
deallocation of memory blocks. They can be used in a post-condition
\begin{itemize}
