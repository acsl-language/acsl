...
This document describes version \ppversion{} of the ANSI/ISO C++ Specification Language (\NAME). 
...
\section*{Funding}
The writing of this document describing \NAME is done in the context of project VESSEDIA,
