\begin{syntax}
  ...
  pred ::= "\true" | "\false" ;
       ...
       | "\let" id "=" pred ";" pred ;
       | [ "\forall" binders ";" guards "==>" pred ]; universal quantification
       | [ "\exists" binders ";" guards "&&" pred ] ; existential quantification
       | "\forall" boolean-binders ";" pred; universal boolean quantification
       | "\exists" boolean-binders ";" pred ; existential quantification
