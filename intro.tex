...
This document is a reference manual for the ACSL implementation
provided by the Frama-C framework~\cite{frama-c}.
ACSL is an acronym for ``ANSI C
Specification Language''. This is a Behavioral Interface Specification
Language (a.k.a. BISL) implemented in the \textsc{Frama-C} framework. As
...
\verb|/*@|~$\ldots$~\verb|*/| style of comments. One-line annotations
in \verb|//@| comments are alike.
