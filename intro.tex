...
ANSI C programming language~\cite{KR88}.
...
be useful for a basic use of that specification language. \todo{mettre en avant ce paragraphe}


\section{Glossary}

\todo{l-value, pre-state, post-state}
