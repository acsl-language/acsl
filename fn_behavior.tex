\begin{syntax}
  function-contract [Empty contracts are forbidden.] ::= requires-clause* post-clause*;
  ...
  \
  post-clause [A contract can contain at most one terminates-clause and one decreases-clause.]::=
                terminates-clause | decreases-clause | simple-clause
  \
  ...
  \
  behavior-body [Empty behavior bodies are forbidden.] ::= assumes-clause* requires-clause* simple-clause*
  \
