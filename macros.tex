...
\newcommand{\bslambda}{\keyword{{\textbackslash}lambda}~}
...
\newcommand{\union}{\keyword{{\textbackslash}union}}
\newcommand{\inter}{\keyword{{\textbackslash}inter}}
...
% BNF grammar
\newcommand{\indexttbase}[2]{\index{#1@\texttt{#2}}}
\newcommand{\indextt}[1]{\indexttbase{#1}{#1}}
\newcommand{\indexttbs}[1]{\indexttbase{#1}{\char92#1}}
\newif\ifspace
\newif\ifnewentry
\newcommand{\addspace}{\ifspace \; \spacefalse \fi}
\newcommand{\term}[2]{\addspace\hbox{\texttt{#1}%
