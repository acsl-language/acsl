...
such as predicates, functions, and class invariants. Axioms and lemmas
do not have an implicit receiver. [TODO - anything else?]

\end{itemize}

In C++, the fields and member functions of class objects are designated using 
either dot or arrow notation. Within \NAME{} annotations, member functions are not
...
Axioms, lemmas, and type definitions are not considered class members with implicit receivers,
but may be designated by appropriate \lstinline|::| qualifiers.

TODO - TBD - data definitions?
...
instance, the qualifier will have type arguments. The corresponding grammar enhancements are shown in 
\begin{lstlisting}
namespace A {
   int f; // A::f
   class B {
