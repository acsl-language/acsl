...
\input{cpp-this.bnf}
\end{cadre}
\caption{Grammar for \textit{this}}
\label{fig:gram:this}
\end{figure}
...
allows both \lstinline|this| and this new construct \lstinline|\textbackslash this| 
...
\item \lstinline|\textbackslash this| designates a \textit{reference} to the object
instance on which a method is acting. It has type either \lstinline|T&| or
\lstinline|const T&|. 
\lstinline|\textbackslash this| may be used in logic definitions
