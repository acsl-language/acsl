...
\begin{itemize}
  \item Clarifies semantics of \lstinline|\valid(_read)| (Section~\ref{subsec:memory})
  \item Adds \lstinline|\aligned| builtin (Section~\ref{subsec:memory})
  \item Adds \lstinline|alignof| keyword (Section~\ref{sec:sizeof-alignof})
\end{itemize}
