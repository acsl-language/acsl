%%% Environnements dont le corps est suprimé lorsque PrintRemarks=false
...
%%% Commandes dont la définition peut être vide lorsque PrintRemarks=false
\ifthenelse{\boolean{PrintRemarks}}%
...
%%% Environnements et commandes non conditionnelle
