...
\newcommand{\ifCPP}[1]{\ifthenelse{\boolean{isCPP}}{\color{darkgreen}#1\color{black}}{}}
\newcommand{\ifCPPinput}[1]{\ifCPP{\input{#1}}}
%% ifCPP without color, as color does not work within grammar files
\newcommand{\ifCPPnc}[1]{\ifthenelse{\boolean{isCPP}}{#1}{}}

\ifthenelse{\boolean{isCPP}}
...
%%\newcommand{\NAME}{ACSL++\xspace}
%%\newcommand{\lang}{C++\xspace}
\newcommand{\review}[1]{\color{darkgreen}Question for Reviewers: #1\color{black}}
...
\newcommand{\ifImpl}[1]{\ifthenelse{\boolean{PrintImplementationRq}}{\textit{#1}}{}}
